...
<div class="panel"><p class="notice">Google News IT/테크 RSS에서 실시간 키워드를 수집하거나 직접 입력합니다.</p><form method="post"><input type="hidden" name="action" value="collect"><button class="primary">트렌드 수집 시작</button></form></div>
